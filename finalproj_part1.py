...
## ---------------PART 1. Make Cache Storing All Species Brief Intro and Specific Url to Details Page----------------
print ("\n ********* PART 1*********")
...
for each in result_1:
    if "View species" in each.text:
        baseurl_2=each["href"]
### go inside species page with full directory
...
### getting common name, scientific name, and conservation status, as well as href for specific species
...
### check if one can go to next page
...
## ---------------PART 2. Get Information from Each Details Page----------------
### information include places, habitats, population,weight, length
